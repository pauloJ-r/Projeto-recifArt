        ...
        <>
            <div className="container-escolha">
                <header className="header-escolha">
                    <NavLink to="/home"> <button><svg xmlns="http://www.w3.org/2000/svg" width="25" height="16" viewBox="0 0 25 16" fill="none">
                ...
                <body>
                    ...
                    <div className="escolha-pessoa">
                        <div className="tipo">
                            <NavLink to="/cadastro_usuario">
                                <img src={Cliente} alt="" />
                                <h3>Cliente</h3>
                            </NavLink>
                        </div>
                        <div className="tipo">
                            <NavLink to="/cadastro_empresa">
                                <img src={Empresa} alt="" />
                                <h3>Empresa</h3>
                            </NavLink>
                        </div>
                        <div className="tipo">
                            <NavLink to="/cadastro_artesao">
                                <img src={Martelo} alt="" />
                                <h3>Artesão</h3>
                            </NavLink>
                        </div>
