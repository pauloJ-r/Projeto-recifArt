...
const LoginArtesao = () => {
  ...
  const handleclicklogin = async (values) => {
    try {
      const response = await Axios.post('http://localhost:3002/login/artesao', {
        email: values.email,
  ...
  return (
     ...
     <div className='lado-esquerdo'>
               <NavLink to="/escolhalog"> <button><svg xmlns="http://www.w3.org/2000/svg" width="25" height="16" viewBox="0 0 25 16" fill="none">
